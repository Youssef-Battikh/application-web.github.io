...
<head>
  ...
  <title>Login - Obsidian Muscle</title>
...
<body class="light-background">
  ...
  <div class="container mt-5 form-container">
    <h2 class="text-center fw-bold mb-5 dark-text">Login To Obsidian Muscle</h2>
    <?php if ($error): ?>
    ...
    <form id="loginForm" class="needs-validation" action="../php/auth.php" method="post" novalidate>
      ...
      <div class="mb-3 form-check actions">
        ...
        <button type="submit" class="btn button-custom" name="submit"><i
